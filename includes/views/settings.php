<div id="wpbody-content">
	...
	<div id="message-confirm" class="updatedConfirm woocommerce-message wc-connect no_display">
		<p>
			<strong>Excelente Plugin Validado y Confirmado</strong> – Ya estas sincronizado
			<br>
			<strong>Licencia: </strong> <label id="lic-confirmation"></label>
		</p>	
	</div>
...
<style>
	.updatedConfirm{
		/*border-left-color: #08fb79;*/
		background-color: rgba(30, 213, 45, 0.25);
		border-left: 4px solid rgb(0, 255, 21);
